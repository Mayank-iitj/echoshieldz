  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto min-h-[550px] mt-12 mb-20 px-4 flex flex-col md:grid md:grid-cols-12 gap-6 items-center justify-center">
      ...
      <motion.div 
        ...
        className="w-full md:col-span-4 glass-card p-6 rounded-2xl border border-neutral-800 shadow-2xl relative overflow-hidden group cursor-pointer"
      >
        <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-emerald-500 to-teal-500 opacity-50" />
        <div className="flex items-center justify-between mb-4">
          <div className="text-xs font-semibold text-neutral-400 uppercase tracking-wider">Shield Status</div>
        ...
        <div className="flex items-center gap-4 mt-2">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-400">ScamBERT 3.0 Live Screening</p>
          </div>
        </div>
        <div className="mt-4 pt-4 border-t border-neutral-900 flex justify-between text-xs text-neutral-500">
      ...
      <motion.div 
        ...
        whileHover={{ scale: 1.02 }}
        className="w-full md:col-span-5 glass-card p-6 rounded-2xl border border-neutral-800 shadow-2xl relative overflow-hidden cursor-pointer"
      >
      ...
      <motion.div 
        ...
        whileHover={{ scale: 1.02 }}
        className="w-full md:col-span-3 glass-card p-6 rounded-2xl border border-neutral-800 shadow-2xl relative overflow-hidden cursor-pointer"
      >
        <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-blue-500 to-indigo-500 opacity-50" />
        <div className="text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-4">Live Threat Feed</div>
        
        <div className="space-y-3">
          <div className="p-2.5 bg-neutral-900/50 rounded-lg border border-neutral-800/50 flex justify-between items-center text-xs">
            <div>
              <p className="text-white font-medium">+91 98765 43210</p>
              <p className="text-[10px] text-neutral-500">KYC Scam • 2m ago</p>
            </div>
          ...
          <div className="p-2.5 bg-neutral-900/50 rounded-lg border border-neutral-800/50 flex justify-between items-center text-xs">
            <div>
              ...
              <p className="text-[10px] text-neutral-500">Lottery Fraud • 15m ago</p>
            </div>
            <span className="px-2 py-0.5 bg-red-500/10 border border-red-500/20 text-red-400 font-semibold rounded text-[10px]">Blocked</span>
          </div>
          ...
          <div className="p-2.5 bg-neutral-900/50 rounded-lg border border-neutral-800/50 flex justify-between items-center text-xs">
            <div>
              ...
              <p className="text-[10px] text-neutral-500">Spam Telemarketer • 1h ago</p>
            </div>
      ...
      <motion.div 
        ...
        whileHover={{ scale: 1.02 }}
        className="w-full md:col-span-5 glass-card p-6 rounded-2xl border border-neutral-800 shadow-2xl md:mt-2 relative overflow-hidden cursor-pointer"
      >
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-[10px] text-neutral-500">ASR Stream</span>
        </div>
        <div className="font-mono text-xs text-neutral-300 space-y-2 leading-relaxed bg-neutral-950 p-3 rounded-lg border border-neutral-900">
          <p className="text-neutral-500"><span className="text-purple-400">Caller [0:04]:</span> "Aapka card block ho gaya hai..."</p>
          <p className="text-neutral-500"><span className="text-purple-400">Caller [0:08]:</span> "Kuch hi der mein SIM band ho jayegi..."</p>
      ...
      <motion.div 
        ...
        whileHover={{ scale: 1.02 }}
        className="w-full md:col-span-7 glass-card p-6 rounded-2xl border border-neutral-800 shadow-2xl md:mt-2 relative overflow-hidden cursor-pointer"
      >
        <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-cyan-500 to-blue-500 opacity-50" />
        <div className="text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-4">EchoShield Stats</div>
        <div className="grid grid-cols-3 gap-4 text-center">
          <div className="p-3 bg-neutral-900/50 rounded-xl border border-neutral-850">
            ...
            <div className="text-[10px] text-neutral-500 font-medium uppercase mt-1">Calls Filtered</div>
          </div>
          <div className="p-3 bg-neutral-900/50 rounded-xl border border-neutral-850">
            <div className="text-2xl font-bold text-emerald-400">100%</div>
            <div className="text-[10px] text-neutral-500 font-medium uppercase mt-1">Device Safety</div>
          </div>
          <div className="p-3 bg-neutral-900/50 rounded-xl border border-neutral-850">
            <div className="text-2xl font-bold text-red-400">92</div>
            <div className="text-[10px] text-neutral-500 font-medium uppercase mt-1">Scams Blocked</div>
          </div>
        </div>
        <div className="mt-4 flex items-center justify-between text-xs text-neutral-400 bg-neutral-950 p-2.5 rounded-lg border border-neutral-900">
          <div className="flex items-center gap-2">
            <CheckCircle className="w-4 h-4 text-emerald-400" />
            <span>Database matchingTRAI Scam registries</span>
          </div>
          <span className="text-neutral-500">Updated 10m ago</span>
        </div>
      </motion.div>
