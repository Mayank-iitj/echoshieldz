...
export default function Operators() {
  const operators = [
    {
      name: 'Reliance Jio',
      logo: (
        <svg viewBox="0 0 100 30" fill="currentColor" className="h-6 w-auto text-[var(--text-secondary)] hover:text-white transition-colors">
  ...
  return (
    <div className="w-full py-8 border-y border-[var(--border-default)] bg-[var(--bg-primary)] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <p className="text-center text-xs font-semibold text-[var(--text-tertiary)] uppercase tracking-wider mb-6">
