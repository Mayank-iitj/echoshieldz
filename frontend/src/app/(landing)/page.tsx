...
export default function LandingPage() {
  ...
  const featuresList = [
    {
      ...
      mockup: (
        <div className="w-full h-full bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between pb-4 border-b border-[var(--border-default)]">
            <span className="text-xs font-semibold text-[var(--text-tertiary)] uppercase">Incoming Call Log</span>
            <span className="text-xs text-[var(--text-tertiary)] font-mono">Today</span>
          </div>
          <div className="space-y-3 my-4">
            <div className="p-3 bg-[var(--bg-elevated)] border border-neutral-850 rounded-xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[var(--text-tertiary)]">Lottery Fraud Scam</p>
                </div>
              </div>
            ...
            <div className="p-3 bg-[var(--bg-elevated)] border border-neutral-850 rounded-xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[var(--text-tertiary)]">Courier Delivery</p>
                </div>
              </div>
              <span className="px-2 py-0.5 bg-emerald-500/10 text-emerald-400 text-[9px] font-bold rounded">5% Risk</span>
            </div>
          </div>
          <div className="flex justify-between text-[10px] text-[var(--text-tertiary)] pt-4 border-t border-[var(--border-default)]">
    ...
    },
    {
      ...
      mockup: (
        <div className="w-full h-full bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-6 flex flex-col justify-between">
          <div className="text-xs font-semibold text-[var(--text-tertiary)] uppercase mb-4">Caller Risk Assessment</div>
          
          <div className="bg-[var(--bg-elevated)]/60 border border-neutral-850 p-4 rounded-xl space-y-4">
            <div className="flex justify-between text-xs">
              <span className="text-[var(--text-secondary)]">Prosody (Voice Stress)</span>
            ...
            <div className="flex justify-between text-xs">
              <span className="text-[var(--text-secondary)]">Deepfake Probability</span>
            ...
            <div className="flex justify-between text-xs">
              <span className="text-[var(--text-secondary)]">Scam BERT Semantic Match</span>
          ...
          <div className="text-[10px] text-[var(--text-tertiary)] pt-4 border-t border-[var(--border-default)] text-center">
    ...
    },
    {
      ...
      mockup: (
        <div className="w-full h-full bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-6 flex flex-col justify-between">
          <div className="text-xs font-semibold text-[var(--text-tertiary)] uppercase mb-4">Security Rules</div>
          <div className="space-y-4 text-xs">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white font-medium">Auto-Block Critical</p>
                <p className="text-[10px] text-[var(--text-tertiary)]">Block calls over 90% risk score</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-[var(--text-tertiary)]">Alert on suspicious classifications</p>
              </div>
              <div className="w-9 h-5 bg-blue-600 rounded-full p-0.5 flex items-center justify-end cursor-pointer">
                <div className="w-4 h-4 bg-white rounded-full" />
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-[var(--text-tertiary)]">Disable network transcripts</p>
              </div>
          ...
          <div className="text-[10px] text-[var(--text-tertiary)] text-center pt-4 border-t border-[var(--border-default)]">
    ...
    },
    {
      ...
      mockup: (
        <div className="w-full h-full bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-6 flex flex-col justify-between">
          <div className="text-xs font-semibold text-[var(--text-tertiary)] uppercase mb-4">AI Security Insights</div>
          
          <div className="space-y-3 bg-[var(--bg-elevated)] p-4 rounded-xl border border-neutral-850">
          ...
          <div className="flex justify-between items-center text-[10px] text-[var(--text-tertiary)] pt-4 border-t border-[var(--border-default)]">
  ...
  const steps = [
    {
      ...
      visual: (
        <div className="w-full max-w-[280px] mx-auto bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-5 shadow-xl">
          ...
          <div className="space-y-2">
            ...
            <button className="w-full py-1.5 bg-[var(--bg-elevated)] border border-[var(--border-strong)] text-[var(--text-secondary)] font-bold text-[10px] rounded-lg">Deny</button>
          </div>
        </div>
      )
    },
      ...
      visual: (
        <div className="w-full max-w-[280px] mx-auto bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-5 shadow-xl">
          <div className="flex justify-between items-center mb-3">
            <span className="text-[9px] uppercase font-bold text-[var(--text-tertiary)] tracking-wider">Analysis Active</span>
            <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
          </div>
          <div className="bg-[var(--bg-elevated)] p-3 rounded-lg border border-neutral-850 font-mono text-[10px] space-y-2 mb-3">
            <p className="text-[var(--text-tertiary)]"><span className="text-[var(--text-secondary)]">Transcribe:</span> "Aapka card block ho..."</p>
          ...
          <div className="flex items-center justify-between text-[10px] font-bold text-white pt-2 border-t border-[var(--border-default)]">
    ...
    },
    {
      ...
      visual: (
        <div className="w-full max-w-[280px] mx-auto bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-5 shadow-xl text-center">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-full text-[9px] font-bold text-emerald-400">
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-white selection:bg-blue-600 selection:text-white font-sans overflow-x-hidden">
      
      {/* 1. NAVIGATION BAR */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg-primary)]/80 backdrop-blur-md border-b border-[var(--border-default)]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-strong)] flex items-center justify-center font-black text-white text-base">
              E
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-xs font-semibold text-[var(--text-secondary)] hover:text-white transition-colors">Company</a>
            <a href="#faq" className="text-xs font-semibold text-[var(--text-secondary)] hover:text-white transition-colors">Support</a>
            <div className="relative group cursor-pointer">
              <span className="text-xs font-semibold text-[var(--text-secondary)] group-hover:text-white transition-colors flex items-center gap-1">
                Resources <ChevronDown className="w-3.5 h-3.5" />
              </span>
              <div className="absolute top-full left-0 mt-2 w-48 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-xl p-2 hidden group-hover:block shadow-2xl">
                <a href="#blog" className="block px-3 py-2 text-xs font-medium text-[var(--text-secondary)] hover:text-white rounded-lg hover:bg-[var(--bg-elevated)]">Security Blog</a>
                <a href="#how-it-works" className="block px-3 py-2 text-xs font-medium text-[var(--text-secondary)] hover:text-white rounded-lg hover:bg-[var(--bg-elevated)]">How It Works</a>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/app" className="text-xs font-semibold text-[var(--text-secondary)] hover:text-white transition-colors">Launch Dashboard</Link>
          ...
          <button 
            ...
            className="md:hidden p-2 text-[var(--text-secondary)] hover:text-white rounded-lg"
          >
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div 
              ...
              exit={{ opacity: 0, y: -10 }}
              className="md:hidden bg-[var(--bg-primary)] border-b border-[var(--border-default)] px-6 py-6 space-y-4"
            >
              <a href="#features" className="block text-sm font-semibold text-[var(--text-secondary)]" onClick={() => setMobileMenuOpen(false)}>Company</a>
              <a href="#faq" className="block text-sm font-semibold text-[var(--text-secondary)]" onClick={() => setMobileMenuOpen(false)}>Support</a>
              <a href="#blog" className="block text-sm font-semibold text-[var(--text-secondary)]" onClick={() => setMobileMenuOpen(false)}>Security Blog</a>
              <Link href="/app" className="block text-sm font-semibold text-[var(--text-secondary)]" onClick={() => setMobileMenuOpen(false)}>Launch Dashboard</Link>
      ...
      <section className="relative pt-36 pb-20 px-6 bg-grid-pattern overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-[1px] bg-[var(--bg-elevated)]" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[var(--border-strong)] bg-[var(--bg-surface)] hover:bg-[var(--bg-elevated)] transition-colors mb-8 cursor-pointer"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-blue-500 animate-pulse" />
            <span className="text-[10px] md:text-[11px] font-semibold text-[var(--text-secondary)] tracking-wide">
          ...
          <motion.p 
            ...
            className="text-sm md:text-base text-[var(--text-secondary)] max-w-xl mx-auto leading-relaxed mb-10"
          >
          ...
          >
            <Link href="/app" className="inline-flex items-center gap-2 px-6 py-3 border border-[var(--border-strong)] hover:border-neutral-700 bg-[var(--bg-surface)] rounded-full text-xs font-bold text-white transition-all shadow-md group">
      ...
      <section className="bg-[var(--bg-primary)] relative">
        <div className="absolute top-0 left-0 w-full h-[1px] bg-[var(--bg-surface)]" />
        <Operators />
      ...
      <section id="features" className="py-24 px-6 bg-[var(--bg-primary)] relative">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[var(--border-strong)] bg-[var(--bg-elevated)]/50 mb-4">
              ...
              <span className="text-[11px] font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Features</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="surface-elevated p-6 rounded-2xl border border-[var(--border-default)] space-y-4 hover:border-[var(--border-strong)] transition-colors cursor-pointer">
          ...
          <div className="mt-16 text-center border-t border-[var(--border-default)] pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-[var(--text-tertiary)]">
      ...
      <section id="how-it-works" className="py-24 px-6 bg-[var(--bg-primary)] relative border-t border-[var(--border-default)]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[var(--border-strong)] bg-[var(--bg-elevated)]/50 mb-4">
              <span className="flex h-2 w-2 rounded-full bg-blue-500 animate-pulse" />
              <span className="text-[11px] font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Steps</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight">
              Get protected in 3 simple steps
            </h2>
            <p className="text-xs md:text-sm text-[var(--text-secondary)] mt-3 max-w-md mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {steps.map((item, i) => (
              <div key={i} className="flex flex-col justify-between space-y-6">
                ...
                <div className="w-full bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl py-8 flex items-center justify-center min-h-[200px]">
                  {item.visual}
                </div>
              </div>
            ))}
      ...
      {/* 7. PRICING SECTION */}
      <section id="pricing" className="py-24 px-6 bg-[var(--bg-primary)] relative border-b border-[var(--border-default)]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-[var(--text-secondary)] mt-2">Upgrade when you are ready.</p>
            
            {/* Toggle switch */}
            <div className="flex items-center justify-center gap-3 mt-8">
              <span className={`text-xs font-semibold ${!isYearly ? 'text-white' : 'text-[var(--text-tertiary)]'}`}>Monthly</span>
              <button 
                onClick={() => setIsYearly(!isYearly)}
                className="w-10 h-6 bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-full p-0.5 flex items-center transition-colors duration-300"
              >
                <div className={`w-4 h-4 bg-white rounded-full transition-transform duration-300 ${isYearly ? 'translate-x-4' : 'translate-x-0'}`} />
              </button>
              <span className={`text-xs font-semibold ${isYearly ? 'text-white' : 'text-[var(--text-tertiary)]'}`}>Yearly (Save 15%)</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            {/* Plan 1: Basic */}
            <div className="surface-elevated p-8 rounded-2xl border border-[var(--border-default)] flex flex-col justify-between min-h-[480px]">
              <div>
                <h4 className="text-lg font-bold text-white">Basic Plan</h4>
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Core local caller ID diagnostics.</p>
                
                <div className="my-8">
                  <span className="text-4xl font-extrabold text-white">$0.00</span>
                  <span className="text-xs text-[var(--text-tertiary)] ml-1">/ month</span>
                </div>
              ...
              <div className="mt-8">
                <Link href="/app" className="block w-full py-3 bg-[var(--bg-elevated)] hover:bg-neutral-850 text-white font-bold text-xs text-center rounded-xl border border-[var(--border-strong)] transition-colors">
                  Start for free
                </Link>
              </div>
            </div>
            ...
            {/* Plan 2: Pro */}
            <div className="surface-elevated p-8 rounded-2xl border border-[var(--border-strong)] flex flex-col justify-between min-h-[480px] relative">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Full-spectrum live voice analysis shield.</p>
      ...
      <section id="blog" className="py-24 px-6 bg-[var(--bg-primary)] relative border-b border-[var(--border-default)]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-16">
            ...
            <Link href="#blog" className="text-xs font-bold text-[var(--text-secondary)] hover:text-white flex items-center gap-1 transition-colors">
          ...
          <div className="grid md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-6 surface-elevated p-8 rounded-2xl border border-[var(--border-default)] hover:border-[var(--border-strong)] transition-all cursor-pointer flex flex-col justify-between min-h-[380px]">
              <div>
                <div className="flex items-center gap-2 mb-6">
                  <span className="px-2.5 py-0.5 bg-[var(--bg-elevated)] text-[var(--text-secondary)] text-[10px] font-bold rounded-full">
                    {blogPosts[0].category}
                  </span>
                  <span className="text-[10px] text-[var(--text-tertiary)]">{blogPosts[0].date}</span>
                </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-[var(--border-default)] text-[10px] text-[var(--text-tertiary)]">
            ...
            <div className="md:col-span-6 space-y-4">
              {blogPosts.slice(1).map((post, i) => (
                <div 
                  key={i} 
                  className="surface-elevated p-6 rounded-2xl border border-[var(--border-default)] hover:border-[var(--border-strong)] transition-all cursor-pointer flex justify-between items-center"
                >
                  <div className="space-y-2 max-w-[80%]">
                    <div className="flex items-center gap-2">
                      <span className="text-[9px] font-bold uppercase text-blue-400">{post.category}</span>
                      <span className="text-[9px] text-[var(--text-tertiary)]">• {post.date}</span>
                    </div>
                    <h4 className="text-sm font-bold text-white tracking-tight truncate leading-snug">
                      {post.title}
                    </h4>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-[var(--bg-elevated)] border border-[var(--border-strong)] flex items-center justify-center text-[var(--text-secondary)] hover:text-white shrink-0">
      ...
      <section id="faq" className="py-24 px-6 bg-[var(--bg-primary)] relative border-b border-[var(--border-default)]">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => {
              ...
              return (
                <div 
                  key={i} 
                  className="bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-xl overflow-hidden transition-all duration-300"
                >
                  <button
                    onClick={() => setActiveFaq(isOpen ? null : i)}
                    className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-[var(--bg-elevated)]/30 transition-colors"
                  >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <div className="px-6 pb-5 pt-1 text-[11px] md:text-xs text-[var(--text-secondary)] leading-relaxed pl-12 border-t border-[var(--border-default)]">
                          {faq.a}
                        </div>
                      </motion.div>
                    )}
      ...
      <section className="py-24 px-6 bg-[var(--bg-primary)] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 p-12 bg-[var(--bg-surface)]/80 border border-[var(--border-default)] rounded-3xl">
          <h2 className="text-2xl md:text-5xl font-black text-white tracking-tight leading-none mb-4">
            Ready to shield your device?
          </h2>
          <p className="text-xs md:text-sm text-[var(--text-secondary)] mb-8 max-w-md mx-auto leading-relaxed">
      ...
      {/* 11. FOOTER */}
      <footer className="py-16 px-6 bg-[var(--bg-primary)] border-t border-[var(--border-default)] text-xs text-[var(--text-tertiary)]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
          
          {/* Logo & Copyright */}
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-strong)] flex items-center justify-center font-black text-white text-sm">
                E
              </div>
